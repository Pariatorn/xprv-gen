...
class HDWalletTool:
    ...
    def load_from_mnemonic(self, mnemonic: str) -> bool:
        ...
        try:
            ...
            try:
                ...
                if h[0] == 0x01:
                    ...
                    seed = hashlib.pbkdf2_hmac(
                        'sha512',
                        normalized_mnemonic.encode('utf-8'),
                        b'electrum',  # Electrum uses "electrum" as salt instead of "mnemonic"
                        2048  # Same iteration count as BIP39
                    )
                else:
                    print("⚠ Not a valid Electrum mnemonic either, but trying anyway...")
            ...
            print(f"✓ Successfully loaded wallet from mnemonic")
    ...
    def load_from_xprv(self, xprv_string: str) -> bool:
        ...
        try:
            ...
            self.mnemonic = None
            print(f"✓ Successfully loaded wallet from xprv")
            print(f"✓ Master xprv: {self.master_xprv}")
            return True
    ...
    def derive_keys_range(self, base_path: str, start_index: int, end_index: int) -> List[Tuple[str, str, str, str]]:
        """
